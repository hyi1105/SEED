...
> Agent-maintained. User does not browse this; use it when recalling past discussions.

## How to use (agent)

1. Scan this index for date / keyword / tag matches.
2. Open the linked file under `sessions/` or `topics/`.
3. Answer the user with date, summary, and key content.
